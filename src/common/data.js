export const COCKTAILS = [
  {
    name: "Midori June Bug",
    reading: "ミドリ・ジューン・バグ",
    description: "メロンリキュールをベースにパイナップル，バナナ，ココナッツのお味と組み合わせ，おしゃれな飾りで鮮やかな色に仕上げたカクテル．フルーツ好きな人にぴったり！",
    abv: 14,
  ...
  },
  {
    name: "Blue Lagoon",
    reading: "ブルーラグーン",
    description: "青色とは対称に，オレンジリキュールを 2 種類私用したさっぱりなカクテル．",
    abv: 14,
    img: "blue-lagoon.jpg",
    rank: 3,
    tags: [ 'Blue', 'Orange' ],
  ...
  },
  {
    name: "Ocean Water",
    reading: "オーシャン・ウォーター",
    description: "海をイメージした色でオレンジの味とココナッツの香りを活かしたとても爽やかな飲み物．",
    abv: 14,
    img: "ocean-water.jpg",
    rank: 2,
  ...
  },
  {
    ...
    reading: "テキーラサンライズ",
    description: "爽やかなオレンジ味で日の出の色をイメージしたおしゃれなカクテル．",
    abv: 12,
